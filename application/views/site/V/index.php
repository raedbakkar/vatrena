						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="ddslick" name="category">
									<option value="0" data-imagesrc="assets/img/icons_search/all_tours.png" selected>All tours</option>
									<option value="1" data-imagesrc="assets/img/icons_search/sightseeing.png">City sightseeing</option>
									<option value="2" data-imagesrc="assets/img/icons_search/museums.png">Museum tours</option>
									<option value="3" data-imagesrc="assets/img/icons_search/historic.png">Historic Buildings</option>
									<option value="4" data-imagesrc="assets/img/icons_search/walking.png">Walking tours</option>
									<option value="5" data-imagesrc="assets/img/icons_search/eat.png">Eat & Drink</option>
									<option value="6" data-imagesrc="assets/img/icons_search/churches.png">Churces</option>
									<option value="7" data-imagesrc="assets/img/icons_search/skyline.png">Skyline tours</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-2 col-sm-3 col-xs-5">
							<div class="form-group">
								<label>Adults</label>
								<div class="numbers-row">
									<input type="text" value="1" class="qty2 form-control" name="adults_2">
								</div>
							</div>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-5">
							<div class="form-group">
								<label>Children</label>
								<div class="numbers-row">
									<input type="text" value="0"  class="qty2 form-control" name="children_2">
								</div>
							</div>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-12">
							<div class="form-group">
								<label>Rooms</label>
								<div class="numbers-row">
									<input type="text" value="1"  class="qty2 form-control" name="rooms">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
					...
					<div class="tour_container">
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_1.jpg" class="img-responsive" alt="Image">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_2.jpg" width="800" height="533" class="img-responsive" alt="Image">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_3.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="badge_save">Save<strong>30%</strong></div>
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_4.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_14.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_5.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.7s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_8.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.8s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_9.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
				...
				<div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.9s">
					<div class="tour_container">
						...
						<div class="img_container">
							<a href="single_tour.html">
								<img src="assets/img/tour_box_12.jpg" width="800" height="533" class="img-responsive" alt="Image">
								<div class="short_info">
			...
			<div class="container margin_60">
				...
				<div class="row">
					<div class="col-md-3 col-sm-6 text-center">
						<p>
							<a href="#"><img src="assets/img/bus.jpg" alt="Pic" class="img-responsive"></a>
						</p>
					...
					<div class="col-md-3 col-sm-6 text-center">
						<p>
							<a href="#"><img src="assets/img/transfer.jpg" alt="Pic" class="img-responsive"></a>
						</p>
					...
					<div class="col-md-3 col-sm-6 text-center">
						<p>
							<a href="#"><img src="assets/img/guide.jpg" alt="Pic" class="img-responsive"></a>
						</p>
					...
					<div class="col-md-3 col-sm-6 text-center">
						<p>
							<a href="#"><img src="assets/img/hotel.jpg" alt="Pic" class="img-responsive"></a>
						</p>
