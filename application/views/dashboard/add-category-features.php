				...
				<div class="m-content">
					...
					<div class="col-md-12">
						...
						<div class="m-portlet m-portlet--tab">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" id="add-feat-category-b" method="POST">
								<div class="m-portlet__body">
									...
									<div class="form-group m-form__group">
										...
										<div class="custom-file">
											<input type="text" name="feature_category" class="form-control m-input m-input--square"  placeholder="Enter Category Feature">
										</div>
									</div>
									<div class="form-group m-form__group">
										<div></div>
										<div class="custom-file">
											<input type="text" name="feature_category_ar" class="form-control m-input m-input--square"  placeholder="Enter Category Feature arabic">
										</div>
									</div>
									<div class="form-group m-form__group">
										<div class="custom-file">
									...
									<div class="form-group m-form__group">
										<div class="custom-file">
											<select class="custom-select form-control" name="filter_activation">
												<option selected="">
													Filter Activation
												</option>
												<option value="1">
