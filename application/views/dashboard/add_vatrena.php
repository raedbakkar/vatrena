			...
			<div class="m-grid__item m-grid__item--fluid m-wrapper">
				...
				<div class="m-content">
					...
					-->
											<form class="m-form m-form--label-align-left- m-form--state-" id="ExcuteVatrena">
												<!--begin: Form Body -->
												<div class="m-portlet__body m-portlet__body--no-padding">
														...
														<div class="m-form__section">
															...
															<div class="form-group m-form__group row">
																...
																<div class="col-xl-9 col-lg-9">
																	<input type="text" name="company_name_ar" class="form-control m-input" placeholder="Name Arabic" value="">
															...
															<div class="form-group m-form__group row">
																...
																<div class="col-xl-9 col-lg-9">
																	<input type="text" name="company_name_en" class="form-control m-input" placeholder="Name English" value="">
																	<span class="m-form__help">
																		Street address, P.O. box, company name, c/o
																	</span>
																</div>
															...
															<div class="form-group m-form__group row">
																...
																<div class="col-xl-9 col-lg-9">
																<textarea name="company_about_ar" class="form-control m-input"></textarea>
																</div>
															</div>
															<div class="form-group m-form__group row">
																<label class="col-xl-3 col-lg-3 col-form-label">
																...
																<div class="col-xl-9 col-lg-9">
																	<textarea name="company_about_en" class="form-control m-input"></textarea>
																</div>
															</div>
															<div class="form-group m-form__group row">
																<label class="col-xl-3 col-lg-3 col-form-label">
													...
													<div class="m-wizard__form-step" id="m_wizard_form_step_2">
														...
														<div class="form-group m-form__group row">
															...
															<div class="col-lg-12">
																...
																<input type="text" name="facebook" class="form-control m-input" placeholder="" value="">
															</div>
															<div class="col-lg-12">
																<label class="form-control-label">
																	- Twitter:
																</label>
																<input type="text" name="twitter" class="form-control m-input" placeholder="" value="">
															</div>
															<div class="col-lg-12">
																<label class="form-control-label">
																	- Google Plus:
																</label>
																<input type="text" name="google_plus" class="form-control m-input" placeholder="" value="">
															</div>
															<div class="col-lg-12">
																<label class="form-control-label">
																	- Linkedin:
																</label>
																<input type="text" name="linkedin" class="form-control m-input" placeholder="" value="">
															</div>
															<div class="col-lg-12">
																<label class="form-control-label">
																	- instagram:
																</label>
																<input type="text" name="instagram" class="form-control m-input" placeholder="" value="">
															</div>
														...
														<div class="form-group m-form__group row">
															<div class="col-lg-12">
																...
																<input type="text" name="website" class="form-control m-input" placeholder="" value="">
															</div>
														</div>
													</div>
															...
															<div class="form-group m-form__group row">
																...
																<div class="col-lg-12 col-md-12 col-sm-12">
																	<select class="form-control m-select2" id="m_select2_11" multiple name="keywords[]">
																		...
																		<option value="<?=  $keyword->keyword_title ?>">
																...
																<div class="col-lg-12 col-md-12 col-sm-12">
																	<select class="form-control m-select2" id="m_select2_3" name="categories[]" multiple="multiple">
																		<?php foreach($cat_keywords as $cat_keyword): ?>
																			<option value="<?=  $cat_keyword->keywords_id ?>">
															...
															<div class="form-group m-form__group row">
																<div class="col-lg-12">
																	...
																	<select class="form-control m-input" name="startingHour">
																		...
																		<?=fetch_timer(null, null, 'starting_hour_night')?>
																	</select>
																</div>
																<div class="col-lg-12">
																	<label class="form-control-label">
