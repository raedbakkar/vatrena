													...
													<div class="m-portlet__body m-portlet__body--no-padding">
															...
															<div class="m-form__section">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="address_en" class="form-control m-input" placeholder="Address english" value="<?= $companies->adress_ar ?>">
														...
														<div class="m-wizard__form-step" id="m_wizard_form_step_4">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<div class="custom-file">
																			<input type="file" class="custom-file-input inputTriggerd" name="inputTriggerd1" data-input-number="1"  data-div-appender=".photoExcuter1">
																	...
																	<div class="col-lg-12">
																		<div class="photoExcuter1 photoAppender mangerImg "></div>
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input type="text" name="photoDescriptionAr1" class="form-control m-input" placeholder="" value="">
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input type="text" name="photoDescriptionEn1" class="form-control m-input" placeholder="" value="">
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		<label class="form-control-label">
																			* Add Category:(أختر قسم للصورة)
																		</label>
																		<select class="form-control m-input" name="photoCategory1">
																			<?php photo_category(); ?>
																		</select>
																	</div>
																</div>
															...
															<div class="row">
																<br>
																<div class="col-lg-12 AddButPhoto">
																	<button type="button" name="Load More" class="btn btn-brand LoadMorePhoto" data-input-number="1">Add Anther Photos</button>
																	<button type="button" name="Load More" class="btn btn-warning removePhoto " data-input-number="1">Delete Anther Photos</button>
																</div>
															</div>
														</div>
															...
															<div class="m-form__section m-form__section--first">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<input type="text" name="video_name[]" class="form-control m-input" placeholder="" value="">
																	</div>
																	<div class="col-lg-12">
																		<label class="form-control-label">
																			* Add Link:
																		</label>
																		<input type="text" name="video_link[]" class="form-control m-input" placeholder="" value="<?= $companies->video ?>">
																	</div>
																</div>
															</div>
														...
														<!--begin: Form Wizard Step 3-->
															<div class="m-wizard__form-step" id="m_wizard_form_step_8">
																<div class="m-form__section m-form__section--first">
																	...
																	<div class="form-group m-form__group row removeF">
																		<div class="col-lg-6">
																			<input name="filepdfname[]" type="text" class="form-control m-input" placeholder="File name">
																		</div>
																		<div class="col-lg-6">
																			<input name="filepdf[]" type="file" class="custom-file-input" id="customFile">
																			<label class="custom-file-label" for="customFile">
																				Choose file
																			</label>
																		</div>
