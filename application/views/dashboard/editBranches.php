				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-content">
						...
						-->
												<form class="wizardItems m-form m-form--label-align-left- m-form--state-" id="m_form">
													<!--begin: Form Body -->
													<div class="m-portlet__body m-portlet__body--no-padding">
															...
															<div class="m-form__section">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="company_name_ar" class="form-control m-input" placeholder="Name Arabic" value="<?= $companies->company_name_ar ?>">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="company_name_en" class="form-control m-input" placeholder="Name English" value="<?= $companies->company_name_en ?>">
																		<span class="m-form__help">
																			Street address, P.O. box, company name, c/o
																		</span>
																	</div>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																	<textarea name="company_about_ar" class="form-control m-input"><?= $companies->company_about ?></textarea>
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<textarea name="company_about_en" class="form-control m-input"><?= $companies->company_about_en ?></textarea>
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">
																	...
																	<div class="col-lg-12">
																		<div class="logoExcuter photoAppender mangerImg"><img src="assets/new_uploads/<?= $companies->logo ?>"></div>
																	</div>
																</div>
																<div class="m-form__heading">
																	<h3 class="m-form__heading-title">
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="address_ar" class="form-control m-input" placeholder="Address arabic" value="<?= $companies->adress_ar ?>">
																		<span class="m-form__help">
																			Street address, P.O. box, company name, c/o
																		</span>
																	</div>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="address_en" class="form-control m-input" placeholder="Address english" value="<?= $companies->adress_en ?>">
																		<span class="m-form__help">
																			Street address, P.O. box, company name, c/o
																		</span>
																	</div>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<input type="text" name="count_views" class="form-control m-input" placeholder="Views" value="<?= $companies->count_views ?>">
																	</div>
																</div>
																<div class="form-group m-form__group row">
																	<label class="col-xl-3 col-lg-3 col-form-label">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select name="area"  class="areaDroper form-control m-input m-input--solid m-select2 reinit" id="m_select2_5" data-url="<?= base_url() ?>dashboard/dropDownAppender " data-appenddiv="geneDropMohafza" data-tab="mohafazat" data-fidname="governorate_id" data-view="dashboard/mohafza_options" data-dropname="category">
																			<option>Area</option>
																			<?php foreach($governorate as $gover): ?>
										                                    	<option value="<?= $gover->gover_id ?>" <?= $gover->gover_id == $companies->area ? 'selected="selected"':''  ?>><?= $gover->gover_title_ar ?></option>
										                                  	<?php endforeach ?>
																		</select>
																	</div>
																</div>
																...
																<div class="form-group m-form__group row geneDropMohafza">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select class="areaDroper form-control m-input m-input--solid m-select2 reinit" id="m_select2_9"  name="moha" data-url="<?= base_url() ?>Dashboard/dropDownAppender" data-appenddiv="geneDropCity" data-tab="city" data-fidname="moha_id" data-view="dashboard/city_options" data-dropname="category">
																			<option value="all">ألكل</option>
																			<?php foreach($mohafaza as $option): ?>
																				<option value="<?= $option->moha_id ?>" <?= $option->moha_id == $companies->mohafaza ? 'selected="selected"':'' ?>><?= $option->moha_title_ar ?></option>
																			<?php endforeach; ?>
																		</select>
																	</div>
																</div>
																<div class="form-group m-form__group row geneDropCity">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select class="areaDroper form-control m-input m-input--solid m-select2 reinit" id="m_select2_7"  name="city" data-url="<?= base_url() ?>Dashboard/dropDownAppender" data-appenddiv="geneDropDistrict" data-tab="district" data-fidname="city_id" data-view="dashboard/district_options" data-dropname="category">
																			<option value="all">ألكل</option>
																			<?php foreach($city as $option): ?>
																				<option value="<?= $option->city_id ?>" <?= $option->city_id == $companies->city ? 'selected="selected"':'' ?>><?= $option->city_name_ar ?></option>
																			<?php endforeach; ?>
																		</select>
																	</div>
																</div>
																<div class="form-group m-form__group row geneDropDistrict">
																	...
																	<div class="col-xl-9 col-lg-9">
																		<select class="areaDroper form-control m-input m-input--solid m-select2 reinit" id="m_select2_8"  name="dist">
																			<option value="all">ألكل</option>
																			<?php foreach($district as $option): ?>
																				<option value="<?= $option->district_id ?>" <?= $option->district_id == $companies->district  ? 'selected="selected"':'' ?>><?= $option->district_title_ar ?></option>
																			<?php endforeach; ?>
																		</select>
																	</div>
																</div>
														...
														<div class="m-wizard__form-step" id="m_wizard_form_step_2">
															<div>
																<div class="phone_Autoloader">
																	<?php $this->load->view('dashboard/phone_edit_numbers', array('phone_numbers'=>$phone_numbers)); ?>
															...
															<div class="telepone_Autoloader">
																<?php $this->load->view('dashboard/telephone_edit', array('telephone_numbers'=>$arrayTele)); ?>
															</div>
															<div class="form-group m-form__group row">
																<div class="col-lg-12 AddButPhoto">
															...
															<div class="form-group m-form__group row">
																...
																<div class="col-lg-12">
																	...
																	<input type="text" name="facebook" class="form-control m-input" placeholder="" value="<?= $companies->facebook ?>">
																</div>
																<div class="col-lg-12">
																	<label class="form-control-label">
																		- Twitter:
																	</label>
																	<input type="text" name="twitter" class="form-control m-input" placeholder="" value="<?= $companies->twitter ?>">
																</div>
																<div class="col-lg-12">
																	<label class="form-control-label">
																		- Google Plus:
																	</label>
																	<input type="text" name="google_plus" class="form-control m-input" placeholder="" value="<?= $companies->google_plus ?>">
																</div>
																<div class="col-lg-12">
																	<label class="form-control-label">
																		- Linkedin:
																	</label>
																	<input type="text" name="linkedin" class="form-control m-input" placeholder="" value="<?= $companies->linkedin ?>">
																</div>
																<div class="col-lg-12">
																	<label class="form-control-label">
																		- instagram:
																	</label>
																	<input type="text" name="instagram" class="form-control m-input" placeholder="" value="<?= $companies->instagram ?>">
																</div>
															...
															<div class="form-group m-form__group row">
																<div class="col-lg-12">
																	...
																	<input type="text" name="website" class="form-control m-input" placeholder="" value="<?= $companies->website ?>">
																</div>
															</div>
														</div>
																...
																<div class="form-group m-form__group row">
																		...
																		<div class="col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control m-select2" id="m_select2_11" multiple name="keywords[]">
																				...
																				<option value="<?=  $keyword->keyword_title ?>" <?php selected_keyword($keyword->keywords_id, $companies->companies_id, 'keyword'); ?>>
																	...
																	<div class="col-lg-12 col-md-12 col-sm-12">
																		<select class="form-control m-select2" id="m_select2_3" name="categories[]" multiple="multiple">
																			<?php foreach($cat_keywords as $cat_keyword): ?>
																				<option value="<?=  $cat_keyword->keywords_id ?>" <?php selected_keyword($cat_keyword->keywords_id, $companies->companies_id, 'category'); ?>>
																...
																<div class="form-group m-form__group row">
																	...
																	<div class="col-lg-12 col-md-12 col-sm-12">
																		<select class="form-control m-select2" id="m_select2_10" multiple name="brand[]">
																			...
																			<option value="<?=  $brand->brand_id ?>" <?php selected_related_compKey($brand->brand_id, $companies->companies_id); ?>>
														...
														<div class="m-wizard__form-step" id="m_wizard_form_step_4">
															<div class="photo_Autoloader">
																<?php $this->load->view('dashboard/user_photo_edit', array('user_photos'=>$user_photos)); ?>
															</div>
															<div class="row">
																<br>
																<div class="col-lg-12 AddButPhoto">
																	<button type="button" name="Load More" class="btn btn-brand LoadMorePhoto" data-input-number="<?= count($user_photos); ?>">Add Anther Photos</button>
																	<button type="button" name="Load More" class="btn btn-warning removePhoto " data-input-number="<?= count($user_photos); ?>">Delete Anther Photos</button>
																</div>
															</div>
															<div class="photo_bannaer">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<div class="custom-file">
																			<input type="file" class="custom-file-input inputTriggerd" name="inputTriggerd" value="<?= base_url() ?>assets/new_uploads/" data-input-number="" data-div-appender=".photoExcuter" data-nextClass="">
																	...
																	<div class="col-lg-12">
																		<div class="photoExcuter photoAppender mangerImg "><img src="<?= base_url() ?>assets/new_uploads/<?= $companies->bannar ?>" alt="photo"></div>
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-md-12 AddButPhoto"> 

																	<input type="file"  name="bannar" class="btn btn-brand add-bannar">
																	<button type="button" name="bannar" class="btn btn-warning remove-bannar">remove bannar</button>
																</div>
															</div>
														</div>
														...
														<div class="m-wizard__form-step" id="m_wizard_form_step_5">
															...
															<input type="hidden"  class="photoAlbum" name="photoAlbum" value="1">
															<input type="hidden"  class="fileAlbum" name="fileAlbum" value="1">
															<div class="row">
																<br>
																<div class="col-lg-12 AddButPhoto">
																	<button type="button" name="Load More" class="btn btn-brand LoadMoreVideoLink" data-input-number="1">Add Anther Video</button>
																	<button type="button" name="Load More" class="btn btn-warning removeVideoLink" data-input-number="1">Delete  Video</button>
																</div>
															</div>
														</div>
														<!--end: Form Wizard Step 3-->
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<select class="form-control m-input" name="startingHour">
																			...
																			<?=fetch_timer($companies->starting_hour, $companies->companies_id, 'starting_hour');?>
																		</select>
																	</div>
																	<div class="col-lg-12">
																		<label class="form-control-label">
																		...
																		<select class="form-control m-input" name="enddingHour">
																			...
																			<?=fetch_timer($companies->ending_hour, $companies->companies_id, 'ending_hour')?>
																		</select>
																	</div>
																</div>
																<div class="m-form__heading">
																...
																<div class="form-group m-form__group row">
																	<div class="col-lg-12">
																		...
																		<select class="form-control m-input" name="startingHourNight">
																			...
																			<?=fetch_timer($companies->starting_hour_night, $companies->companies_id, 'starting_hour_night')?>
																		</select>
																	</div>
																	<div class="col-lg-12">
																		<label class="form-control-label">
																		...
																		<select class="form-control m-input" name="enddingHourNight">
																			...
																			<?=fetch_timer($companies->ending_hour_night, $companies->companies_id, 'ending_hour_night')?>
																		</select>
																	</div>
																	<div class="col-lg-12 col-md-9 col-sm-12">
																		...
																		<select name="holidays[]" class="form-control form-control--fixed m-bootstrap-select  m_selectpicker" multiple  data-max-options="2">
																			<?= explode_holidays($companies->holidays); ?>
																		</select>
																	</div>
																</div>
															</div>
