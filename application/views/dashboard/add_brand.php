				...
				<div class="m-content">
					...
					<div class="col-md-12">
						...
						<div class="m-portlet m-portlet--tab">
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" id="add-brand" method="POST">
								<div class="m-portlet__body">
									<div class="form-group m-form__group">
										<label>Brand Title Arabic</label>
										<div class="custom-file">
											<input type="text" name="brand_ar" class="form-control m-input m-input--square">
										</div>
									</div>
									<div class="form-group m-form__group">
										<label>Brand Title English</label>
										<div class="custom-file">
											<input type="text" name="brand_en" class="form-control m-input m-input--square">
										</div>
									</div>
