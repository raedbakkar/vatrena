						...
						<div class="m-portlet__body">
							...
							<div class="form-group m-form__group">
								...
								<select class="form-control m-input m-input--solid m-select2" id="m_select2_11" multiple name="keywords[]">
									...
									<option value="<?=  $keyword->keywords_id ?>" <?php selected_keyword_by_dad_id($keyword->keywords_id, $category_row->keywords_id, 'category') ?>>
							...
							<div class="form-group m-form__group">
								...
								<select class="form-control m-input m-input--solid m-select2 SelectXor" id="m_select2_5"  name="vatrena_name">
									<option></option>
							...
							<div class="form-group m-form__group">
								...
								<div class="category-img-holder">
									<img src="assets/new_uploads/<?= $category_row->picutre ?>">
								</div>
							</div>
